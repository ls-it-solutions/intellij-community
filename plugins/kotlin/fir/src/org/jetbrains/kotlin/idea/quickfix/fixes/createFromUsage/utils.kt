...
context (KtAnalysisSession)
internal fun KtExpression.renderExpectedType(): String? =
    getExpectedType()?.render(KtTypeRendererForSource.WITH_SHORT_NAMES, Variance.INVARIANT)
...
private fun KtValueArgument.renderExpectedParameter(): String {
    ...
    val parameterTypeAsString = expectedArgumentType?.render(KtTypeRendererForSource.WITH_SHORT_NAMES, Variance.INVARIANT) ?: "Any"
