...
public abstract class InlineScopesAndK2IdeK2CodeEvaluateExpressionTestGenerated extends AbstractInlineScopesAndK2IdeK2CodeEvaluateExpressionTest {
    @RunWith(JUnit3RunnerWithInners.class)
    @TestMetadata("../testData/evaluation/singleBreakpoint")
    public abstract static class SingleBreakpoint extends AbstractInlineScopesAndK2IdeK2CodeEvaluateExpressionTest {
        @RunWith(JUnit3RunnerWithInners.class)
        @TestMetadata("../testData/evaluation/singleBreakpoint/compilingEvaluator")
        public abstract static class CompilingEvaluator extends AbstractInlineScopesAndK2IdeK2CodeEvaluateExpressionTest {
            @RunWith(JUnit3RunnerWithInners.class)
        ...
        public static class Coroutines extends AbstractInlineScopesAndK2IdeK2CodeEvaluateExpressionTest {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest(this::doSingleBreakpointTest, this, TargetBackend.JVM_WITH_IR_EVALUATOR, testDataFilePath);
            }
