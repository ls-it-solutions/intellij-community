...
public abstract class IrKotlinEvaluateExpressionTestGenerated extends AbstractIrKotlinEvaluateExpressionTest {
    ...
    public abstract static class SingleBreakpoint extends AbstractIrKotlinEvaluateExpressionTest {
        ...
        public static class FunWithDefaultParam extends AbstractIrKotlinEvaluateExpressionTest {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest(this::doSingleBreakpointTest, this, TargetBackend.JVM_IR_WITH_OLD_EVALUATOR, testDataFilePath);
            }
    ...
    public abstract static class JvmMultiModule extends AbstractIrKotlinEvaluateExpressionTest {
        ...
        public static class Delegates extends AbstractIrKotlinEvaluateExpressionTest {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest(this::doJvmMultiModuleTest, this, TargetBackend.JVM_IR_WITH_OLD_EVALUATOR, testDataFilePath);
            }
