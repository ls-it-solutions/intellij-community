...
public abstract class K1IdeK2CodeKotlinEvaluateExpressionInMppTestGenerated extends AbstractK1IdeK2CodeKotlinEvaluateExpressionInMppTest {
    @RunWith(JUnit3RunnerWithInners.class)
    @TestMetadata("testData/evaluation/singleBreakpoint")
    public abstract static class SingleBreakpoint extends AbstractK1IdeK2CodeKotlinEvaluateExpressionInMppTest {
        @RunWith(JUnit3RunnerWithInners.class)
        @TestMetadata("testData/evaluation/singleBreakpoint/compilingEvaluator")
        public abstract static class CompilingEvaluator extends AbstractK1IdeK2CodeKotlinEvaluateExpressionInMppTest {
            @RunWith(JUnit3RunnerWithInners.class)
            @TestMetadata("testData/evaluation/singleBreakpoint/compilingEvaluator/inaccessibleMembers")
            public static class InaccessibleMembers extends AbstractK1IdeK2CodeKotlinEvaluateExpressionInMppTest {
        ...
        public static class CreateExpression extends AbstractK1IdeK2CodeKotlinEvaluateExpressionInMppTest {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest(this::doSingleBreakpointTest, this, TargetBackend.JVM_IR_WITH_IR_EVALUATOR, testDataFilePath);
            }
        ...
        public static class ExtraVariables extends AbstractK1IdeK2CodeKotlinEvaluateExpressionInMppTest {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest(this::doSingleBreakpointTest, this, TargetBackend.JVM_IR_WITH_IR_EVALUATOR, testDataFilePath);
            }
        ...
        public static class Frame extends AbstractK1IdeK2CodeKotlinEvaluateExpressionInMppTest {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest(this::doSingleBreakpointTest, this, TargetBackend.JVM_IR_WITH_IR_EVALUATOR, testDataFilePath);
            }
        ...
        public static class FunWithDefaultParam extends AbstractK1IdeK2CodeKotlinEvaluateExpressionInMppTest {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest(this::doSingleBreakpointTest, this, TargetBackend.JVM_IR_WITH_IR_EVALUATOR, testDataFilePath);
            }
        ...
        public static class ImplicitClassReceiver extends AbstractK1IdeK2CodeKotlinEvaluateExpressionInMppTest {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest(this::doSingleBreakpointTest, this, TargetBackend.JVM_IR_WITH_IR_EVALUATOR, testDataFilePath);
            }
        ...
        public static class JavaContext extends AbstractK1IdeK2CodeKotlinEvaluateExpressionInMppTest {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest(this::doSingleBreakpointTest, this, TargetBackend.JVM_IR_WITH_IR_EVALUATOR, testDataFilePath);
            }
        ...
        public static class Labels extends AbstractK1IdeK2CodeKotlinEvaluateExpressionInMppTest {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest(this::doSingleBreakpointTest, this, TargetBackend.JVM_IR_WITH_IR_EVALUATOR, testDataFilePath);
            }
        ...
        public static class Lambdas extends AbstractK1IdeK2CodeKotlinEvaluateExpressionInMppTest {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest(this::doSingleBreakpointTest, this, TargetBackend.JVM_IR_WITH_IR_EVALUATOR, testDataFilePath);
            }
        ...
        public static class SimpleConstructors extends AbstractK1IdeK2CodeKotlinEvaluateExpressionInMppTest {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest(this::doSingleBreakpointTest, this, TargetBackend.JVM_IR_WITH_IR_EVALUATOR, testDataFilePath);
            }
        ...
        public static class SimpleLocals extends AbstractK1IdeK2CodeKotlinEvaluateExpressionInMppTest {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest(this::doSingleBreakpointTest, this, TargetBackend.JVM_IR_WITH_IR_EVALUATOR, testDataFilePath);
            }
        ...
        public static class SimpleSmartcasts extends AbstractK1IdeK2CodeKotlinEvaluateExpressionInMppTest {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest(this::doSingleBreakpointTest, this, TargetBackend.JVM_IR_WITH_IR_EVALUATOR, testDataFilePath);
            }
    ...
    public abstract static class MultipleBreakpoints extends AbstractK1IdeK2CodeKotlinEvaluateExpressionInMppTest {
        @RunWith(JUnit3RunnerWithInners.class)
        @TestMetadata("testData/evaluation/multipleBreakpoints/library")
        public static class Library extends AbstractK1IdeK2CodeKotlinEvaluateExpressionInMppTest {
            private void runTest(String testDataFilePath) throws Exception {
    ...
    public static class Multiplatform extends AbstractK1IdeK2CodeKotlinEvaluateExpressionInMppTest {
        private void runTest(String testDataFilePath) throws Exception {
            KotlinTestUtils.runTest(this::doMultipleBreakpointsTest, this, TargetBackend.JVM_IR_WITH_IR_EVALUATOR, testDataFilePath);
        }
